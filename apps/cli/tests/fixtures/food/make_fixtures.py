...
def header_rows(offset=0):
    ...
    return [
        ...
        row(shift({3: f"食{SP}品{SP}名", 4: f"廃{SP}棄{SP}率", 5: "エネルギー", 7: f"たんぱく質", 9: "炭水化物",
                   14: "無 機 質", 15: f"ビ{SP}{SP}タ{SP}{SP}ミ{SP}{SP}ン"})),
        row(shift({7: "アミノ酸組成による\nたんぱく質", 8: "たんぱく質", 9: "利用可能炭水化物", 12: "食物繊維総量",
                   14: "ナ ト リ ウ ム", 15: "ビタミンK", 16: "ビ\nタ\nミ\nン\nＢ１２"})),
        row(shift({9: "利用可能炭水化物\n（単糖当量）", 11: f"差引き法による\n利用可能炭水化物{SP}"})),
        row(),
        row(shift({3: "単位", 4: "%", 5: "kJ", 6: "kcal", 7: "(…………… g ………………)", 14: "mg",
                   15: "(…… μg……)"})),
        row(shift({3: "成分識別子", 4: "REFUSE", 5: "ENERC", 6: "ENERC_KCAL", 7: "PROTCAA", 8: "PROT-",
                   9: "CHOAVLM", 11: "CHOAVLDF-", 12: "FIB-", 14: "NA", 15: "VITK ", 16: "VITB12"})),
    ]


FOODS = [
    # group, code, index, name, refuse, ENERC, KCAL, PROTCAA, PROT-, CHOAVLM, marker, CHOAVLDF-, FIB-, spacer, NA, VITK, VITB12, remarks
    ["01", "01001", "0001", f"アマランサス{SP}玄穀", 0, 1452, 343, "(11.3)", 12.7, 63.5, "*", 59.9, 7.4, None, 1, "(0)", "(0)", ""],
    ["06", "06153", "0582", f"（たまねぎ類）{SP}たまねぎ{SP}りん茎{SP}生", 6, 138, 33, 0.7, "1.0", "(3.9)", "*", 7.0, 1.5, None, 2, 0, "-",
     "別名： 玉ねぎ、オニオン\n廃棄部位： 皮（保護葉）、底盤部及び頭部"],
    ["06", "06154", "0583", f"（たまねぎ類）{SP}たまねぎ{SP}りん茎{SP}ゆで", 0, 200, 31, 0.5, 0.8, "20.3†", None, 6.9, 1.7, None, "(Tr)", "Tr", "(Tr)",
     "†は規定法による測定値"],
    ["10", "10330", "1520", f"＜魚類＞{SP}（あじ類）{SP}まあじ{SP}皮つき{SP}フライ", "0", 1134, 270, "(16.6)", 20.1, "(7.9)", None, 12.3, None, None, "*", 7, None,
     "ヨウ素： 第3章参照"],
    ["01", "1002", "0002", f"アマランサス{SP}ゆで", 0, 1, 1, 1, 1, 1, None, 1, 1, None, 1, 1, 1, ""],
    ["18", "99999", "9999", "重複した食品", 0, 1, 1, 1, 1, 1, None, 1, 1, None, 1, 1, 1, ""],
    ["18", "99999", "9999", "重複した食品", 0, 1, 1, 1, 1, 1, None, 1, 1, None, 1, 1, 1, ""],
    ["18", "18001", "2400", f"和風料理{SP}和え物類{SP}青菜の白和え", 120, 1, 1, 1, 1, 1, None, 1, 1, None, 1, 1, 1, ""],
]
