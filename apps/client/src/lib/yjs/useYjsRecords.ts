...
function ymapToRecord(ymap: Y.Map<string>): DatabaseRecord {
  ...
  return {
    ...
    orgUsername: ymap.get('orgUsername') as string | undefined,
    repoUsername: ymap.get('repoUsername') as string | undefined,
    operatorId: ymap.get('operatorId') as string | undefined,
  }
}
