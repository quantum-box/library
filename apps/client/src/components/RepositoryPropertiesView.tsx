...
export function RepositoryPropertiesView({
  ...
  const StateIcon = permission ? ShieldAlert : AlertCircle
  ...
  return (
    ...
    >
      ...
      {/* Only the section body waits on the read: the header and the section
          strip stay put so switching tabs never blanks the whole screen. */}
      {loading && !properties ? (
        <div
          className="flex min-h-0 flex-1 items-center justify-center bg-surface/50 p-6"
          aria-busy="true"
        ...
        <div className="flex min-h-0 flex-1 items-center justify-center bg-surface/50 p-6">
